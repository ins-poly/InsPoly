...
- Next owner decisions for PR #1: whether to accept absent GitHub CI or configure checks, whether to manually update the PR body with reviewer doc links, whether historical `release_manifests/` files should stay in the PR, and whether to approve marking the Draft PR ready for review. Merge remains a separate explicit approval step.
