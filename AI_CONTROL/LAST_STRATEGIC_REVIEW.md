...
- The known-case benchmark has been expanded to `known_case_benchmark_v2` with 24 compact offline cases, including false-positive and sidecar-context controls.
...
- The highest-leverage benchmark expansion has now been completed at the advisory-control level. Further benchmark work should be human-curated public-case labeling, not runtime/model tuning.
...
- Review whether the expanded known-case benchmark should be followed by human-curated public-case exact-wallet labeling.
